  ...
  return (
    <section id="who-am-i">
      ...
      <p>
        ...
        deadlines. Deep foundation of core web principles and constantly hungry
        to learn new technologies. Most happy when producing beautiful React
        components with Styled Components but just as at home with other
